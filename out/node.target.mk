...
quiet_cmd__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache = ACTION _tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache $@
cmd__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(obj)/gen; "$(builddir)/mkcodecache" "$(obj)/gen/node_code_cache.cc"
...
$(obj)/gen/node_code_cache.cc: $(builddir)/mkcodecache FORCE_DO_CMD
	$(call do_cmd,_tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache)

all_deps += $(obj)/gen/node_code_cache.cc
action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache_outputs := $(obj)/gen/node_code_cache.cc

### Rules for action "node_mksnapshot":
quiet_cmd__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot = ACTION _tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot $@
cmd__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(obj)/gen; "$(builddir)/node_mksnapshot" "$(obj)/gen/node_snapshot.cc"
...
$(obj)/gen/node_snapshot.cc: $(builddir)/node_mksnapshot FORCE_DO_CMD
	$(call do_cmd,_tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot)

all_deps += $(obj)/gen/node_snapshot.cc
action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot_outputs := $(obj)/gen/node_snapshot.cc

### Rules for action "reset_openssl_cnf":
quiet_cmd__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf = ACTION _tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf $@
cmd__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(builddir)/obj.target/deps/openssl; python tools/copyfile.py ./deps/openssl/openssl/apps/openssl.cnf "$(builddir)/obj.target/deps/openssl/openssl.cnf"
...
$(builddir)/obj.target/deps/openssl/openssl.cnf: $(srcdir)/deps/openssl/openssl/apps/openssl.cnf FORCE_DO_CMD
	$(call do_cmd,_tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf)

all_deps += $(builddir)/obj.target/deps/openssl/openssl.cnf
action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf_outputs := $(builddir)/obj.target/deps/openssl/openssl.cnf
...
$(OBJS): | $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache_outputs) $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot_outputs) $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf_outputs)
...
$(builddir)/node: | $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache_outputs) $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot_outputs) $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf_outputs)

# Preserve order dependency of special output on deps.
$(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_run_mkcodecache_outputs) $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_node_mksnapshot_outputs) $(action__tmp_usr_ports_www_node_work_node_v17_0_1_node_gyp_node_target_reset_openssl_cnf_outputs): | $(obj).target/deps/histogram/libhistogram.a $(obj).target/deps/uvwasi/libuvwasi.a $(obj).target/libnode.a $(builddir)/mkcodecache $(builddir)/node_mksnapshot $(obj).target/libnode_text_start.a $(obj).target/tools/v8_gypfiles/libv8_snapshot.a $(obj).target/tools/v8_gypfiles/libv8_libplatform.a $(obj).target/tools/icu/icui18n.stamp $(obj).target/tools/icu/icuuc.stamp $(obj).target/deps/llhttp/libllhttp.a $(obj).target/deps/openssl/libopenssl.a $(builddir)/openssl-cli $(obj).target/deps/ngtcp2/libngtcp2.a $(obj).target/deps/ngtcp2/libnghttp3.a $(obj).target/deps/googletest/gtest_prod.stamp $(obj).target/node_dtrace_header.stamp $(obj).target/specialize_node_d.stamp $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/v8_gypfiles/libv8_base_without_compiler.a $(obj).target/tools/v8_gypfiles/torque_generated_definitions.stamp $(obj).target/tools/v8_gypfiles/v8_internal_headers.stamp $(obj).target/tools/v8_gypfiles/torque_runtime_support.stamp $(obj).target/tools/v8_gypfiles/v8_flags.stamp $(obj).target/tools/v8_gypfiles/v8_shared_internal_headers.stamp $(obj).target/tools/v8_gypfiles/v8_headers.stamp $(obj).target/tools/v8_gypfiles/v8_config_headers.stamp $(obj).target/tools/v8_gypfiles/cppgc_headers.stamp $(obj).target/tools/v8_gypfiles/v8_version.stamp $(obj).target/tools/v8_gypfiles/libv8_libbase.a $(obj).target/tools/v8_gypfiles/v8_bigint.stamp $(obj).target/tools/v8_gypfiles/v8_cppgc_shared.stamp $(obj).target/tools/v8_gypfiles/cppgc_base.stamp $(obj).target/tools/v8_gypfiles/libv8_zlib.a $(obj).target/tools/v8_gypfiles/run_gen-regexp-special-case.stamp $(obj).target/tools/v8_gypfiles/postmortem-metadata.stamp $(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp $(obj).target/tools/v8_gypfiles/libv8_compiler.a $(obj).target/tools/v8_gypfiles/libv8_initializers.a $(obj).target/tools/v8_gypfiles/torque_generated_initializers.stamp
