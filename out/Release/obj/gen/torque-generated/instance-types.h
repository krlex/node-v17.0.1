...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_STRUCT_TYPE, 76) \
      ...
      V(BREAK_POINT_TYPE, 94) \
      V(BREAK_POINT_INFO_TYPE, 95) \
      V(CACHED_TEMPLATE_OBJECT_TYPE, 96) \
      V(CALL_HANDLER_INFO_TYPE, 97) \
      V(CLASS_POSITIONS_TYPE, 98) \
      V(DEBUG_INFO_TYPE, 99) \
      V(ENUM_CACHE_TYPE, 100) \
      V(FEEDBACK_CELL_TYPE, 101) \
      V(FUNCTION_TEMPLATE_RARE_DATA_TYPE, 102) \
      V(INTERCEPTOR_INFO_TYPE, 103) \
      V(INTERPRETER_DATA_TYPE, 104) \
      V(MODULE_REQUEST_TYPE, 105) \
      V(PROMISE_CAPABILITY_TYPE, 106) \
      V(PROMISE_REACTION_TYPE, 107) \
      V(PROPERTY_DESCRIPTOR_OBJECT_TYPE, 108) \
      V(PROTOTYPE_INFO_TYPE, 109) \
      V(REG_EXP_BOILERPLATE_DESCRIPTION_TYPE, 110) \
      V(SCRIPT_TYPE, 111) \
      V(SOURCE_TEXT_MODULE_INFO_ENTRY_TYPE, 112) \
      V(STACK_FRAME_INFO_TYPE, 113) \
      V(TEMPLATE_OBJECT_DESCRIPTION_TYPE, 114) \
      V(TUPLE2_TYPE, 115) \
      V(WASM_EXCEPTION_TAG_TYPE, 116) \
      V(WASM_INDIRECT_FUNCTION_TABLE_TYPE, 117) \
    ...
    V(MAP_TYPE, 171) \
    V(MEGA_DOM_HANDLER_TYPE, 172) \
    V(ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE, 173) \
    V(PREPARSE_DATA_TYPE, 174) \
    V(PROPERTY_ARRAY_TYPE, 175) \
    V(PROPERTY_CELL_TYPE, 176) \
    V(SCOPE_INFO_TYPE, 177) \
    V(SHARED_FUNCTION_INFO_TYPE, 178) \
    V(SMI_BOX_TYPE, 179) \
    V(SMI_PAIR_TYPE, 180) \
    V(SORT_STATE_TYPE, 181) \
    V(SWISS_NAME_DICTIONARY_TYPE, 182) \
    V(WEAK_ARRAY_LIST_TYPE, 183) \
    V(WEAK_CELL_TYPE, 184) \
    V(FIRST_JS_RECEIVER_TYPE, 185) \
      V(FIRST_WASM_OBJECT_TYPE, 185) \
        V(WASM_ARRAY_TYPE, 185) \
        V(WASM_STRUCT_TYPE, 186) \
      V(LAST_WASM_OBJECT_TYPE, 186) \
      V(JS_PROXY_TYPE, 187) \
      V(FIRST_JS_OBJECT_TYPE, 188) \
        V(JS_OBJECT_TYPE, 1057) \
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 188) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 188) \
            V(JS_GLOBAL_OBJECT_TYPE, 188) \
            V(JS_GLOBAL_PROXY_TYPE, 189) \
            V(JS_MODULE_NAMESPACE_TYPE, 190) \
        ...
        V(FIRST_JS_API_OBJECT_TYPE, 1058) \
          V(JS_API_OBJECT_TYPE, 1058) \
          V(JS_LAST_DUMMY_API_OBJECT_TYPE, 2058) \
        V(LAST_JS_API_OBJECT_TYPE, 2058) \
        V(FIRST_JS_FUNCTION_OR_BOUND_FUNCTION_TYPE, 2059) \
          V(JS_BOUND_FUNCTION_TYPE, 2059) \
          V(FIRST_JS_FUNCTION_TYPE, 2060) \
            V(JS_FUNCTION_TYPE, 2060) \
            V(FIRST_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2061) \
              V(BIGINT64_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2061) \
              V(BIGUINT64_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2062) \
              V(FLOAT32_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2063) \
              V(FLOAT64_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2064) \
              V(INT16_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2065) \
              V(INT32_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2066) \
              V(INT8_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2067) \
              V(UINT16_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2068) \
              V(UINT32_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2069) \
              V(UINT8_CLAMPED_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2070) \
              V(UINT8_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2071) \
            V(LAST_TYPED_ARRAY_CONSTRUCTOR_TYPE, 2071) \
            V(JS_ARRAY_CONSTRUCTOR_TYPE, 2072) \
            V(JS_PROMISE_CONSTRUCTOR_TYPE, 2073) \
            V(JS_REG_EXP_CONSTRUCTOR_TYPE, 2074) \
          V(LAST_JS_FUNCTION_TYPE, 2074) \
        V(LAST_JS_FUNCTION_OR_BOUND_FUNCTION_TYPE, 2074) \
        V(FIRST_JS_PROTOTYPE_TYPE, 2075) \
          V(JS_ARRAY_ITERATOR_PROTOTYPE_TYPE, 2075) \
          V(JS_ITERATOR_PROTOTYPE_TYPE, 2076) \
          V(JS_MAP_ITERATOR_PROTOTYPE_TYPE, 2077) \
          V(JS_OBJECT_PROTOTYPE_TYPE, 2078) \
          V(JS_PROMISE_PROTOTYPE_TYPE, 2079) \
          V(JS_REG_EXP_PROTOTYPE_TYPE, 2080) \
          V(JS_SET_ITERATOR_PROTOTYPE_TYPE, 2081) \
          V(JS_SET_PROTOTYPE_TYPE, 2082) \
          V(JS_STRING_ITERATOR_PROTOTYPE_TYPE, 2083) \
          V(JS_TYPED_ARRAY_PROTOTYPE_TYPE, 2084) \
        V(LAST_JS_PROTOTYPE_TYPE, 2084) \
        V(FIRST_JS_COLLECTION_ITERATOR_TYPE, 2085) \
          V(FIRST_JS_MAP_ITERATOR_TYPE, 2085) \
            V(JS_MAP_KEY_ITERATOR_TYPE, 2085) \
            V(JS_MAP_KEY_VALUE_ITERATOR_TYPE, 2086) \
            V(JS_MAP_VALUE_ITERATOR_TYPE, 2087) \
          V(LAST_JS_MAP_ITERATOR_TYPE, 2087) \
          V(FIRST_JS_SET_ITERATOR_TYPE, 2088) \
            V(JS_SET_KEY_VALUE_ITERATOR_TYPE, 2088) \
            V(JS_SET_VALUE_ITERATOR_TYPE, 2089) \
          V(LAST_JS_SET_ITERATOR_TYPE, 2089) \
        V(LAST_JS_COLLECTION_ITERATOR_TYPE, 2089) \
        V(FIRST_JS_GENERATOR_OBJECT_TYPE, 2090) \
          V(JS_GENERATOR_OBJECT_TYPE, 2090) \
          V(JS_ASYNC_FUNCTION_OBJECT_TYPE, 2091) \
          V(JS_ASYNC_GENERATOR_OBJECT_TYPE, 2092) \
        V(LAST_JS_GENERATOR_OBJECT_TYPE, 2092) \
        V(FIRST_JS_ARRAY_BUFFER_VIEW_TYPE, 2093) \
          V(JS_DATA_VIEW_TYPE, 2093) \
          V(JS_TYPED_ARRAY_TYPE, 2094) \
        V(LAST_JS_ARRAY_BUFFER_VIEW_TYPE, 2094) \
        V(FIRST_JS_COLLECTION_TYPE, 2095) \
          V(JS_MAP_TYPE, 2095) \
          V(JS_SET_TYPE, 2096) \
        V(LAST_JS_COLLECTION_TYPE, 2096) \
        V(FIRST_JS_WEAK_COLLECTION_TYPE, 2097) \
          V(JS_WEAK_MAP_TYPE, 2097) \
          V(JS_WEAK_SET_TYPE, 2098) \
        V(LAST_JS_WEAK_COLLECTION_TYPE, 2098) \
        V(JS_ARGUMENTS_OBJECT_TYPE, 2099) \
        V(JS_ARRAY_TYPE, 2100) \
        V(JS_ARRAY_BUFFER_TYPE, 2101) \
        V(JS_ARRAY_ITERATOR_TYPE, 2102) \
        V(JS_ASYNC_FROM_SYNC_ITERATOR_TYPE, 2103) \
        V(JS_COLLATOR_TYPE, 2104) \
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 2105) \
        V(JS_DATE_TYPE, 2106) \
        V(JS_DATE_TIME_FORMAT_TYPE, 2107) \
        V(JS_DISPLAY_NAMES_TYPE, 2108) \
        V(JS_ERROR_TYPE, 2109) \
        V(JS_FINALIZATION_REGISTRY_TYPE, 2110) \
        V(JS_LIST_FORMAT_TYPE, 2111) \
        V(JS_LOCALE_TYPE, 2112) \
        V(JS_MESSAGE_OBJECT_TYPE, 2113) \
        V(JS_NUMBER_FORMAT_TYPE, 2114) \
        V(JS_PLURAL_RULES_TYPE, 2115) \
        V(JS_PROMISE_TYPE, 2116) \
        V(JS_REG_EXP_TYPE, 2117) \
        V(JS_REG_EXP_STRING_ITERATOR_TYPE, 2118) \
        V(JS_RELATIVE_TIME_FORMAT_TYPE, 2119) \
        V(JS_SEGMENT_ITERATOR_TYPE, 2120) \
        V(JS_SEGMENTER_TYPE, 2121) \
        V(JS_SEGMENTS_TYPE, 2122) \
        V(JS_STRING_ITERATOR_TYPE, 2123) \
        V(JS_V8_BREAK_ITERATOR_TYPE, 2124) \
        V(JS_WEAK_REF_TYPE, 2125) \
        V(WASM_GLOBAL_OBJECT_TYPE, 2126) \
        V(WASM_INSTANCE_OBJECT_TYPE, 2127) \
        V(WASM_MEMORY_OBJECT_TYPE, 2128) \
        V(WASM_MODULE_OBJECT_TYPE, 2129) \
        V(WASM_TABLE_OBJECT_TYPE, 2130) \
        V(WASM_TAG_OBJECT_TYPE, 2131) \
        V(WASM_VALUE_OBJECT_TYPE, 2132) \
      V(LAST_JS_OBJECT_TYPE, 2132) \
    V(LAST_JS_RECEIVER_TYPE, 2132) \
  V(LAST_HEAP_OBJECT_TYPE, 2132) \
...
#define TORQUE_ASSIGNED_INSTANCE_TYPE_LIST(V) \
  ...
  V(JS_LAST_DUMMY_API_OBJECT_TYPE) \
...
#define TORQUE_INSTANCE_CHECKERS_SINGLE_ONLY_DECLARED(V) \
  ...
  V(JSLastDummyApiObject, JS_LAST_DUMMY_API_OBJECT_TYPE) \
