...
TNode<Uint16T> LoadSharedFunctionInfoFormalParameterCountWithoutReceiver_0(compiler::CodeAssemblerState* state_, TNode<SharedFunctionInfo> p_sfi) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint16T> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint16T> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint16T> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, kJSArgcIncludesReceiver);
    ca_.Branch(tmp2, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{tmp1});
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp3 = Convert_int32_uint16_0(state_, TNode<Uint16T>{tmp1});
    tmp4 = FromConstexpr_int32_constexpr_int32_0(state_, kDontAdaptArgumentsSentinel);
    tmp5 = CodeStubAssembler(state_).Word32NotEqual(TNode<Int32T>{tmp3}, TNode<Int32T>{tmp4});
    ca_.Branch(tmp5, &block4, std::vector<compiler::Node*>{}, &block5, std::vector<compiler::Node*>{tmp1});
  }
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp6 = FromConstexpr_uint32_constexpr_int31_0(state_, 1);
    tmp7 = CodeStubAssembler(state_).Uint32Sub(TNode<Uint32T>{tmp1}, TNode<Uint32T>{tmp6});
    tmp8 = Convert_uint16_uint32_0(state_, TNode<Uint32T>{tmp7});
    ca_.Goto(&block5, tmp8);
  }

  TNode<Uint16T> phi_bb5_1;
  if (block5.is_used()) {
    ca_.Bind(&block5, &phi_bb5_1);
    ca_.Goto(&block3, phi_bb5_1);
  }

  TNode<Uint16T> phi_bb3_1;
  if (block3.is_used()) {
    ca_.Bind(&block3, &phi_bb3_1);
    ca_.Goto(&block6, phi_bb3_1);
  }

  TNode<Uint16T> phi_bb6_1;
    ca_.Bind(&block6, &phi_bb6_1);
  return TNode<Uint16T>{phi_bb6_1};
}
...
TNode<Uint16T> LoadSharedFunctionInfoFormalParameterCountWithReceiver_0(compiler::CodeAssemblerState* state_, TNode<SharedFunctionInfo> p_sfi) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 42);
    tmp1 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{p_sfi, tmp0});
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprBoolNot(kJSArgcIncludesReceiver)));
    ca_.Branch(tmp2, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{tmp1});
  }
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp6 = FromConstexpr_uint32_constexpr_int31_0(state_, 1);
    tmp7 = CodeStubAssembler(state_).Uint32Add(TNode<Uint32T>{tmp1}, TNode<Uint32T>{tmp6});
    tmp8 = Convert_uint16_uint32_0(state_, TNode<Uint32T>{tmp7});
    ca_.Goto(&block5, tmp8);
  }
