...
TNode<Object> ReduceAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue) {
  ...
  compiler::CodeAssemblerParameterizedLabel<JSTypedArray, Object, UintPtrT> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSTypedArray, Object, UintPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSTypedArray, Object, UintPtrT, Object> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Object, UintPtrT, Object, Object> block17(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Object, UintPtrT, Object> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp9, &block12, std::vector<compiler::Node*>{phi_bb3_5, phi_bb3_8, phi_bb3_9}, &block13, std::vector<compiler::Node*>{phi_bb3_5, phi_bb3_8, phi_bb3_9});
  }
  ...
  TNode<Oddball> tmp10;
  if (block12.is_used()) {
    ca_.Bind(&block12, &phi_bb12_5, &phi_bb12_8, &phi_bb12_9);
    tmp10 = Undefined_0(state_);
    ca_.Goto(&block7, phi_bb12_5, phi_bb12_8, phi_bb12_9, tmp10);
  }
  ...
  TNode<Numeric> tmp12;
  if (block13.is_used()) {
    ca_.Bind(&block13, &phi_bb13_5, &phi_bb13_8, &phi_bb13_9);
    tmp11 = (TNode<JSTypedArray>{tmp0});
tmp12 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp2, TNode<Object>(), tmp11, phi_bb13_9));
    ca_.Goto(&block7, tmp11, phi_bb13_8, phi_bb13_9, tmp12);
  }

  TNode<JSTypedArray> phi_bb7_5;
  TNode<Object> phi_bb7_8;
  TNode<UintPtrT> phi_bb7_9;
  TNode<Object> phi_bb7_10;
  TNode<Oddball> tmp13;
  if (block7.is_used()) {
    ca_.Bind(&block7, &phi_bb7_5, &phi_bb7_8, &phi_bb7_9, &phi_bb7_10);
    compiler::CodeAssemblerLabel label14(&ca_);
    tmp13 = Cast_TheHole_0(state_, TNode<Object>{phi_bb7_8}, &label14);
    ca_.Goto(&block17, phi_bb7_8, phi_bb7_9, phi_bb7_8, phi_bb7_8);
    if (label14.is_used()) {
      ca_.Bind(&label14);
      ca_.Goto(&block18, phi_bb7_8, phi_bb7_9, phi_bb7_8, phi_bb7_8);
    }
  }
  ...
  if (block18.is_used()) {
    ...
    tmp16 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{phi_bb18_9});
    tmp17 = CodeStubAssembler(state_).Call(TNode<Context>{p_context}, TNode<Object>{p_callbackfn}, TNode<Object>{tmp15}, TNode<Object>{ca_.UncheckedCast<Object>(phi_bb18_11)}, TNode<Object>{phi_bb7_10}, TNode<Object>{tmp16}, TNode<Object>{tmp0});
    ca_.Goto(&block15, tmp17, phi_bb18_9, phi_bb18_11);
  }
  ...
  if (block17.is_used()) {
    ...
    ca_.Goto(&block15, phi_bb7_10, phi_bb17_9, phi_bb17_11);
  }
  ...
  if (block15.is_used()) {
    ...
    tmp19 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb15_9}, TNode<UintPtrT>{tmp18});
    ca_.Goto(&block5, phi_bb7_5, phi_bb15_8, tmp19);
  }
  ...
  if (block4.is_used()) {
    ...
    tmp20 = Cast_TheHole_0(state_, TNode<Object>{phi_bb4_8}, &label21);
    ca_.Goto(&block22, phi_bb4_5, phi_bb4_8, phi_bb4_8, phi_bb4_8);
    if (label21.is_used()) {
      ca_.Bind(&label21);
      ca_.Goto(&block23, phi_bb4_5, phi_bb4_8, phi_bb4_8, phi_bb4_8);
    }
  }
...
TF_BUILTIN(TypedArrayPrototypeReduce, CodeStubAssembler) {
  ...
  if (block15.is_used()) {
    ...
    tmp15 = ReduceAllElements_0(state_, TNode<Context>{parameter0}, TNode<JSTypedArray>{tmp2}, TNode<JSReceiver>{tmp6}, TNode<Object>{phi_bb15_9});
