...
TF_BUILTIN(ArrayFrom, CodeStubAssembler) {
  ...
  if (block46.is_used()) {
    ...
    ca_.Goto(&block45, phi_bb46_10, phi_bb46_16, tmp47);
  }
  ...
  if (block47.is_used()) {
    ...
    ca_.Goto(&block45, phi_bb47_10, phi_bb47_16, tmp50);
  }
  ...
  if (block45.is_used()) {
    ca_.Bind(&block45, &phi_bb45_10, &phi_bb45_16, &phi_bb45_20);
    ...
    CodeStubAssembler(state_).CallRuntime(Runtime::kReThrow, parameter0, phi_bb45_20);
  ...
  if (block43.is_used()) {
    ...
    tmp51 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kFastCreateDataProperty), parameter0, phi_bb26_12, phi_bb43_16, phi_bb43_19);
    }
    ...
    tmp55 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb43_16}, TNode<Smi>{tmp54});
    ca_.Goto(&block32, phi_bb43_10, tmp55);
  }
  ...
  if (block54.is_used()) {
    ...
    ca_.Goto(&block51, phi_bb54_10, tmp56);
  }
  ...
  if (block53.is_used()) {
    ...
    ca_.Goto(&block51, phi_bb53_10, tmp57);
  }
  ...
  if (block51.is_used()) {
    ...
    ca_.Goto(&block57, phi_bb51_10, tmp58);
  }
  ...
  if (block57.is_used()) {
    ...
    tmp59 = NumberIsLessThan_0(state_, TNode<Number>{phi_bb57_14}, TNode<Number>{tmp29});
    ca_.Branch(tmp59, &block55, std::vector<compiler::Node*>{phi_bb57_10, phi_bb57_14}, &block56, std::vector<compiler::Node*>{phi_bb57_10, phi_bb57_14});
  }
  ...
  if (block55.is_used()) {
    ...
    tmp60 = CodeStubAssembler(state_).GetProperty(TNode<Context>{parameter0}, TNode<Object>{tmp28}, TNode<Object>{phi_bb55_14});
  ...
  if (block58.is_used()) {
    ...
    tmp62 = CodeStubAssembler(state_).Call(TNode<Context>{parameter0}, TNode<Object>{tmp61}, TNode<Object>{tmp16}, TNode<Object>{tmp60}, TNode<Object>{phi_bb58_14});
    ca_.Goto(&block60, phi_bb58_10, phi_bb58_14, tmp62);
  }
  ...
  if (block59.is_used()) {
    ...
    ca_.Goto(&block60, phi_bb59_10, phi_bb59_14, tmp60);
  }
  ...
  if (block60.is_used()) {
    ...
    tmp63 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kFastCreateDataProperty), parameter0, phi_bb51_13, phi_bb60_14, phi_bb60_16);
    tmp64 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
    tmp65 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb60_14}, TNode<Smi>{tmp64});
    ca_.Goto(&block57, phi_bb60_10, tmp65);
  }
