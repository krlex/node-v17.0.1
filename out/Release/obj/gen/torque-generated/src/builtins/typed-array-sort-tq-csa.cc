...
TF_BUILTIN(TypedArrayPrototypeSort, CodeStubAssembler) {
  ...
  if (block18.is_used()) {
    ...
    tmp28 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{phi_bb18_16}, TNode<UintPtrT>{tmp9});
    ca_.Branch(tmp28, &block16, std::vector<compiler::Node*>{phi_bb18_16}, &block17, std::vector<compiler::Node*>{phi_bb18_16});
  }
...
tmp29 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp20, TNode<Object>(), tmp7, phi_bb16_16));
    std::tie(tmp30, tmp31, tmp32) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{tmp24}).Flatten();
    tmp33 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{phi_bb16_16});
    tmp34 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp33});
    tmp35 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp32});
    tmp36 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp34}, TNode<UintPtrT>{tmp35});
    ca_.Branch(tmp36, &block25, std::vector<compiler::Node*>{phi_bb16_16, phi_bb16_16, phi_bb16_16}, &block26, std::vector<compiler::Node*>{phi_bb16_16, phi_bb16_16, phi_bb16_16});
  }
  ...
  if (block25.is_used()) {
    ...
    tmp44 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{phi_bb25_16});
    ...
    ca_.Branch(tmp47, &block32, std::vector<compiler::Node*>{phi_bb25_16, phi_bb25_16, phi_bb25_16}, &block33, std::vector<compiler::Node*>{phi_bb25_16, phi_bb25_16, phi_bb25_16});
  }
  ...
  if (block32.is_used()) {
    ca_.Bind(&block32, &phi_bb32_16, &phi_bb32_22, &phi_bb32_23);
    ...
    tmp53 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb32_16}, TNode<UintPtrT>{tmp52});
  ...
  TNode<BoolT> tmp57;
  if (block37.is_used()) {
    ca_.Bind(&block37, &phi_bb37_16);
    tmp57 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{phi_bb37_16}, TNode<UintPtrT>{tmp9});
    ca_.Branch(tmp57, &block35, std::vector<compiler::Node*>{phi_bb37_16}, &block36, std::vector<compiler::Node*>{phi_bb37_16});
  }
  ...
  if (block35.is_used()) {
    ...
    tmp61 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{phi_bb35_16});
    ...
    ca_.Branch(tmp64, &block43, std::vector<compiler::Node*>{phi_bb35_16, phi_bb35_16, phi_bb35_16, phi_bb35_16}, &block44, std::vector<compiler::Node*>{phi_bb35_16, phi_bb35_16, phi_bb35_16, phi_bb35_16});
  }

  TNode<UintPtrT> phi_bb43_16;
  TNode<UintPtrT> phi_bb43_22;
  TNode<UintPtrT> phi_bb43_27;
  TNode<UintPtrT> phi_bb43_28;
  TNode<IntPtrT> tmp65;
  TNode<IntPtrT> tmp66;
  TNode<Object> tmp67;
  TNode<IntPtrT> tmp68;
  ...
  if (block43.is_used()) {
    ca_.Bind(&block43, &phi_bb43_16, &phi_bb43_22, &phi_bb43_27, &phi_bb43_28);
...
tmp71 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(2)).descriptor(), tmp21, parameter0, tmp7, phi_bb43_22, tmp70));
    tmp72 = FromConstexpr_uintptr_constexpr_int31_0(state_, 1);
    tmp73 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb43_16}, TNode<UintPtrT>{tmp72});
    ca_.Goto(&block37, tmp73);
  }

  TNode<UintPtrT> phi_bb44_16;
  TNode<UintPtrT> phi_bb44_22;
  TNode<UintPtrT> phi_bb44_27;
  TNode<UintPtrT> phi_bb44_28;
  if (block44.is_used()) {
    ca_.Bind(&block44, &phi_bb44_16, &phi_bb44_22, &phi_bb44_27, &phi_bb44_28);
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<UintPtrT> phi_bb36_16;
  if (block36.is_used()) {
    ca_.Bind(&block36, &phi_bb36_16);
    arguments.PopAndReturn(tmp7);
  }
}
