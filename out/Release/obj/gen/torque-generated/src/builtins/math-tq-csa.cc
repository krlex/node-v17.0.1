...
TF_BUILTIN(MathHypot, CodeStubAssembler) {
  ...
  if (block14.is_used()) {
    ...
    ca_.Branch(tmp26, &block17, std::vector<compiler::Node*>{phi_bb14_8, phi_bb14_9, phi_bb14_10}, &block18, std::vector<compiler::Node*>{phi_bb14_8, phi_bb14_9, phi_bb14_10});
  }
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_8, &phi_bb17_9, &phi_bb17_10);
    ca_.Goto(&block18, phi_bb17_8, tmp13, phi_bb17_10);
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Goto(&block9, phi_bb18_8, phi_bb18_9, phi_bb18_10);
  }
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(tmp30, &block19, std::vector<compiler::Node*>{phi_bb4_8, phi_bb4_9}, &block20, std::vector<compiler::Node*>{phi_bb4_8, phi_bb4_9});
  }
  ...
  if (block20.is_used()) {
    ...
    ca_.Branch(phi_bb20_8, &block22, std::vector<compiler::Node*>{phi_bb20_8, phi_bb20_9}, &block23, std::vector<compiler::Node*>{phi_bb20_8, phi_bb20_9});
  }
  ...
  if (block23.is_used()) {
    ...
    tmp34 = CodeStubAssembler(state_).Float64Equal(TNode<Float64T>{phi_bb23_9}, TNode<Float64T>{tmp33});
    ca_.Branch(tmp34, &block25, std::vector<compiler::Node*>{phi_bb23_8, phi_bb23_9}, &block26, std::vector<compiler::Node*>{phi_bb23_8, phi_bb23_9});
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Goto(&block33, phi_bb26_8, phi_bb26_9, tmp36, tmp37, tmp38);
  }
  ...
  if (block33.is_used()) {
    ...
    tmp39 = CodeStubAssembler(state_).IntPtrLessThan(TNode<IntPtrT>{phi_bb33_12}, TNode<IntPtrT>{torque_arguments.length});
    ca_.Branch(tmp39, &block31, std::vector<compiler::Node*>{phi_bb33_8, phi_bb33_9, phi_bb33_10, phi_bb33_11, phi_bb33_12}, &block32, std::vector<compiler::Node*>{phi_bb33_8, phi_bb33_9, phi_bb33_10, phi_bb33_11, phi_bb33_12});
  }
  ...
  if (block31.is_used()) {
    ...
    ca_.Branch(tmp45, &block39, std::vector<compiler::Node*>{phi_bb31_8, phi_bb31_9, phi_bb31_10, phi_bb31_11, phi_bb31_12, phi_bb31_12, phi_bb31_12, phi_bb31_12, phi_bb31_12}, &block40, std::vector<compiler::Node*>{phi_bb31_8, phi_bb31_9, phi_bb31_10, phi_bb31_11, phi_bb31_12, phi_bb31_12, phi_bb31_12, phi_bb31_12, phi_bb31_12});
  }
  ...
  if (block39.is_used()) {
    ...
    tmp46 = TimesSizeOf_float64_or_hole_0(state_, TNode<IntPtrT>{phi_bb39_23});
    ...
    tmp52 = CodeStubAssembler(state_).Float64Div(TNode<Float64T>{tmp51}, TNode<Float64T>{phi_bb39_9});
    tmp53 = CodeStubAssembler(state_).Float64Mul(TNode<Float64T>{tmp52}, TNode<Float64T>{tmp52});
    tmp54 = CodeStubAssembler(state_).Float64Sub(TNode<Float64T>{tmp53}, TNode<Float64T>{phi_bb39_11});
    tmp55 = CodeStubAssembler(state_).Float64Add(TNode<Float64T>{phi_bb39_10}, TNode<Float64T>{tmp54});
    tmp56 = CodeStubAssembler(state_).Float64Sub(TNode<Float64T>{tmp55}, TNode<Float64T>{phi_bb39_10});
    ...
    tmp59 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb39_12}, TNode<IntPtrT>{tmp58});
    ca_.Goto(&block33, phi_bb39_8, phi_bb39_9, tmp55, tmp57, tmp59);
  }
  ...
  if (block32.is_used()) {
    ...
    tmp60 = CodeStubAssembler(state_).Float64Sqrt(TNode<Float64T>{phi_bb32_10});
    tmp61 = CodeStubAssembler(state_).Float64Mul(TNode<Float64T>{tmp60}, TNode<Float64T>{phi_bb32_9});
