...
TF_BUILTIN(ArrayPrototypeSlice, CodeStubAssembler) {
  ...
  TNode<Number> phi_bb13_12;
  TNode<Number> tmp21;
  TNode<BoolT> tmp22;
  if (block13.is_used()) {
    ca_.Bind(&block13, &phi_bb13_12);
    tmp21 = FromConstexpr_Number_constexpr_int31_0(state_, 0);
    tmp22 = NumberIsLessThan_0(state_, TNode<Number>{phi_bb13_12}, TNode<Number>{tmp21});
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp23 = CodeStubAssembler(state_).NumberAdd(TNode<Number>{tmp6}, TNode<Number>{phi_bb13_12});
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp26 = Min_0(state_, TNode<Number>{phi_bb13_12}, TNode<Number>{tmp6});
  ...
  if (block17.is_used()) {
    ...
    tmp27 = CodeStubAssembler(state_).NumberSub(TNode<Number>{phi_bb17_13}, TNode<Number>{phi_bb9_10});
    ...
    tmp30 = HandleFastSlice_0(state_, TNode<NativeContext>{parameter0}, TNode<Object>{tmp5}, TNode<Number>{phi_bb9_10}, TNode<Number>{tmp29}, &label31);
    ca_.Goto(&block45);
    if (label31.is_used()) {
      ca_.Bind(&label31);
      ca_.Goto(&block46);
  ...
  if (block46.is_used()) {
    ...
    ca_.Goto(&block49, phi_bb9_10, tmp33);
  }
  ...
  TNode<Number> phi_bb49_16;
  TNode<BoolT> tmp34;
  if (block49.is_used()) {
    ca_.Bind(&block49, &phi_bb49_10, &phi_bb49_16);
    tmp34 = NumberIsLessThan_0(state_, TNode<Number>{phi_bb49_10}, TNode<Number>{phi_bb17_13});
    ca_.Branch(tmp34, &block47, std::vector<compiler::Node*>{phi_bb49_10, phi_bb49_16}, &block48, std::vector<compiler::Node*>{phi_bb49_10, phi_bb49_16});
  }

  TNode<Number> phi_bb47_10;
  TNode<Number> phi_bb47_16;
  TNode<Oddball> tmp35;
  TNode<Oddball> tmp36;
  TNode<BoolT> tmp37;
  if (block47.is_used()) {
    ca_.Bind(&block47, &phi_bb47_10, &phi_bb47_16);
    tmp35 = ca_.CallStub<Oddball>(Builtins::CallableFor(ca_.isolate(), Builtin::kHasProperty), parameter0, tmp5, phi_bb47_10);
    tmp36 = True_0(state_);
    tmp37 = CodeStubAssembler(state_).TaggedEqual(TNode<HeapObject>{tmp35}, TNode<HeapObject>{tmp36});
    ca_.Branch(tmp37, &block50, std::vector<compiler::Node*>{phi_bb47_10, phi_bb47_16, phi_bb47_10}, &block51, std::vector<compiler::Node*>{phi_bb47_10, phi_bb47_16, phi_bb47_10});
  }

  TNode<Number> phi_bb50_10;
  TNode<Number> phi_bb50_16;
  TNode<Number> phi_bb50_17;
  TNode<Object> tmp38;
  TNode<Object> tmp39;
  if (block50.is_used()) {
    ca_.Bind(&block50, &phi_bb50_10, &phi_bb50_16, &phi_bb50_17);
    tmp38 = CodeStubAssembler(state_).GetProperty(TNode<Context>{parameter0}, TNode<Object>{tmp5}, TNode<Object>{phi_bb50_17});
    tmp39 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kFastCreateDataProperty), parameter0, tmp32, phi_bb50_16, tmp38);
    ca_.Goto(&block51, phi_bb50_10, phi_bb50_16, phi_bb50_17);
  }

  TNode<Number> phi_bb51_10;
  TNode<Number> phi_bb51_16;
  TNode<Number> phi_bb51_17;
  TNode<Number> tmp40;
  TNode<Number> tmp41;
  TNode<Number> tmp42;
  TNode<Number> tmp43;
  if (block51.is_used()) {
    ca_.Bind(&block51, &phi_bb51_10, &phi_bb51_16, &phi_bb51_17);
    tmp40 = FromConstexpr_Number_constexpr_int31_0(state_, 1);
    tmp41 = CodeStubAssembler(state_).NumberAdd(TNode<Number>{phi_bb51_10}, TNode<Number>{tmp40});
    tmp42 = FromConstexpr_Number_constexpr_int31_0(state_, 1);
    tmp43 = CodeStubAssembler(state_).NumberAdd(TNode<Number>{phi_bb51_16}, TNode<Number>{tmp42});
    ca_.Goto(&block49, tmp41, tmp43);
  }

  TNode<Number> phi_bb48_10;
  TNode<Number> phi_bb48_16;
  TNode<String> tmp44;
  TNode<Object> tmp45;
  if (block48.is_used()) {
    ca_.Bind(&block48, &phi_bb48_10, &phi_bb48_16);
    tmp44 = kLengthString_0(state_);
    tmp45 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtin::kSetProperty), parameter0, tmp32, tmp44, phi_bb48_16);
