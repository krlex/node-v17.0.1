...
TNode<Object> ReduceRightAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue) {
  ...
  compiler::CodeAssemblerParameterizedLabel<JSTypedArray, Object, Object> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Object, Object, Object> block17(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Object, Object, Object> block16(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block3.is_used()) {
    ...
    ca_.Branch(tmp11, &block11, std::vector<compiler::Node*>{phi_bb3_5, phi_bb3_8}, &block12, std::vector<compiler::Node*>{phi_bb3_5, phi_bb3_8});
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Goto(&block6, phi_bb11_5, phi_bb11_8, tmp12);
  }
...
tmp14 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp2, TNode<Object>(), tmp13, tmp6));
    ca_.Goto(&block6, tmp13, phi_bb12_8, tmp14);
  }
  ...
  TNode<Oddball> tmp15;
  if (block6.is_used()) {
    ca_.Bind(&block6, &phi_bb6_5, &phi_bb6_8, &phi_bb6_10);
    compiler::CodeAssemblerLabel label16(&ca_);
    tmp15 = Cast_TheHole_0(state_, TNode<Object>{phi_bb6_8}, &label16);
    ca_.Goto(&block16, phi_bb6_8, phi_bb6_8, phi_bb6_8);
    if (label16.is_used()) {
      ca_.Bind(&label16);
      ca_.Goto(&block17, phi_bb6_8, phi_bb6_8, phi_bb6_8);
    }
  }
  ...
  if (block17.is_used()) {
    ...
    tmp18 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{tmp6});
    tmp19 = CodeStubAssembler(state_).Call(TNode<Context>{p_context}, TNode<Object>{p_callbackfn}, TNode<Object>{tmp17}, TNode<Object>{ca_.UncheckedCast<Object>(phi_bb17_11)}, TNode<Object>{phi_bb6_10}, TNode<Object>{tmp18}, TNode<Object>{tmp0});
    ca_.Goto(&block14, tmp19, phi_bb17_11);
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16, &phi_bb16_8, &phi_bb16_11, &phi_bb16_12);
    ca_.Goto(&block14, phi_bb6_10, phi_bb16_11);
  }

  TNode<Object> phi_bb14_8;
  TNode<Object> phi_bb14_11;
  if (block14.is_used()) {
    ca_.Bind(&block14, &phi_bb14_8, &phi_bb14_11);
    ca_.Goto(&block5, phi_bb6_5, phi_bb14_8, tmp6);
  }
  ...
  if (block21.is_used()) {
    ...
    ca_.Bind(&block23);
  return TNode<Object>{ca_.UncheckedCast<Object>(phi_bb22_9)};
}
...
TF_BUILTIN(TypedArrayPrototypeReduceRight, CodeStubAssembler) {
  ...
  if (block15.is_used()) {
    ...
    tmp15 = ReduceRightAllElements_0(state_, TNode<Context>{parameter0}, TNode<JSTypedArray>{tmp2}, TNode<JSReceiver>{tmp6}, TNode<Object>{phi_bb15_9});
