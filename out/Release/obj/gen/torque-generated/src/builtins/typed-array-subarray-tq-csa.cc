...
TF_BUILTIN(TypedArrayPrototypeSubArray, CodeStubAssembler) {
  ...
  if (block11.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).UintPtrSub(TNode<UintPtrT>{phi_bb11_12}, TNode<UintPtrT>{phi_bb7_10});
    ...
    tmp26 = CodeStubAssembler(state_).UintPtrGreaterThan(TNode<UintPtrT>{phi_bb7_10}, TNode<UintPtrT>{tmp25});
  ...
  if (block17.is_used()) {
    ...
    tmp29 = CodeStubAssembler(state_).UintPtrGreaterThan(TNode<UintPtrT>{phi_bb7_10}, TNode<UintPtrT>{tmp28});
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp30 = CodeStubAssembler(state_).WordShl(TNode<UintPtrT>{phi_bb7_10}, TNode<UintPtrT>{tmp21});
