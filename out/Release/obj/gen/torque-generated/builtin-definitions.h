...
TFJ(ArrayBufferPrototypeGetMaxByteLength, 0, kReceiver) \
TFJ(ArrayBufferPrototypeGetResizable, 0, kReceiver) \
TFJ(SharedArrayBufferPrototypeGetMaxByteLength, 0, kReceiver) \
TFJ(SharedArrayBufferPrototypeGetGrowable, 0, kReceiver) \
...
TFC(WasmAllocateFreshRtt, WasmAllocateFreshRtt) \
